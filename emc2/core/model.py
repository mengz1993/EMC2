...
class E3SMv1(Model):
    def __init__(self, file_path, time_range=None, load_processed=False, time_dim="time", appended_str=False,
                 all_appended_in_lat=False, hyd_types=["cl", "ci", "pl", "pi"], is_v1=True):
        """
...
class E3SMv3(E3SMv1):
    def __init__(self, file_path, time_range=None, load_processed=False, time_dim="time", appended_str=False,
                 all_appended_in_lat=False, hyd_types=["cl", "ci", "pl"], is_v1=False):
        """
        ...
        all_appended_in_lat: bool
            ...
            the appended str from both the lat and lon dims (relevant if appended_str is True).
        """
        super().__init__(file_path, time_range, load_processed, time_dim, appended_str, all_appended_in_lat, hyd_types, is_v1)
...
class SCREAM(E3SMv1):
    def __init__(self, file_path, time_range=None, load_processed=False, time_dim="time", appended_str=False,
                 all_appended_in_lat=False, hyd_types=["cl", "ci", "pl", "pi"], is_v1=False):
        """
